...
window.onload = divs.forEach(function (el) {
  el.style.height = el.offsetHeight + 100 + "px";
});
window.onresize = divs.forEach(function (el) {
  el.style.height = el.offsetHeight + 100 + "px";
...
var enableBodyScroll = bodyScrollLock.enableBodyScroll; // Open the aquaculture maps
...
},{"body-scroll-lock":"node_modules/body-scroll-lock/lib/bodyScrollLock.min.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
